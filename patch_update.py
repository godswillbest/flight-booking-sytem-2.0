...
old_flights = text[text.index("        flights = [\n"):text.index("        cursor.executemany(\"\"\"\n            INSERT INTO flights", text.index("        flights = [\n"))
new_flights = '''        flights = [
...
'''
text = text[:text.index(old_flights)] + new_flights + text[text.index(old_flights) + len(old_flights):]
